...
- [Snapshot - Editing](#snapshot---editing)
  - [Text](#text)
...
To set the text, just type or paste it, and click the set button. Once you have done it, the text will be displayed character by character in an interactive diagram, where you can click each single character to get its ordinal-based coordinate, or add [features](usr-features.md) to it.
...
- an open set of [features](usr-features.md).
...
- [edit the operation](usr-operation.md).
...
Once you have added the operations in a batch, you can [edit](usr-operation.md) each of them to add or refine its data.
