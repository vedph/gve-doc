...
- [Operation - Editing](#operation---editing)
  - [General](#general)
  - [Sources](#sources)
...
- `features`: the features of this operation. Here you can add as many [features](usr-features.md) as you want. Operation features have a richer model, including not only name, value, and set policy, but also the following properties:
