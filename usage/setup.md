...
> Omit `sudo` for Windows. Do not close the terminal until you are working with the editor. When you are done, press CTRL+C to gracefully stop containers, and once shutdown has completed you can safely close the terminal.
...
If you installed Docker Desktop, you will find the whole stack of Cadmus GVE in it. Next time, you can just **start** it again with the play button in the UI, rather than opening the terminal and running the command.
