...
VEdition will provide a new digital edition of Goethe's _Venetian epigrams_ (here GVE for short). Given the highly peculiar nature of this text, this digital-born project also aims to propose a new digital model and software tools for authorial philology applied to similar scenarios.
