...
👉 Finally, we add a **background image** from some URL (e.g. <https://raw.githubusercontent.com/vedph/gve-doc/main/model/img/limerick.png>), so that we can see the facsimile behind our snapshot. Its parameters are:
